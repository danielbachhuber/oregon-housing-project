...
METHODOLOGY: Underproduction is calculated using the Up for Growth methodology, which Oregon's OHNA adopted (OHNA 2026 Results Report, p. 5, Figure 4). It compares the target number of housing units a market should have against actual units available for year-round occupancy. Regions where demand exceeds supply are experiencing underproduction.

HOW "SHOULD HAVE" IS DETERMINED: The target number of units = (actual households + missing households) / 0.95. "Missing households" are people who would have formed their own household (roommates splitting up, adult children moving out) but couldn't because housing is too expensive or unavailable. This is estimated by comparing current headship rates (% of people who head a household) by age cohort (18-64 only) against year 2000 baseline rates, which represent a more balanced market. The 5% target vacancy rate represents healthy, unconstrained market conditions (75th percentile of national vacancy 1980-2000). The "actual units available" side removes uninhabitable units and second/vacation homes from the total housing stock.
